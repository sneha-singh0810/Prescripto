  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        <button className={`py-1 px-3 borede rounde text-sm transition-all sm:hidden ${showFilter ? 'bg-primay text-white' : ''}`} onClick={()=> setShowFilter(prev => !prev)}>Filters</button>
